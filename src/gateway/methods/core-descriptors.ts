...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "sessions.purge", scope: "operator.admin" },
  ...
  { name: "protocol-traces.list", scope: "operator.read" },
  { name: "protocol-traces.clear", scope: "operator.read" },
  { name: "ping.peer-to-gw", scope: "operator.read", advertise: false },
  { name: "ping.gw-to-peer.ack", scope: "operator.read", advertise: false },
  { name: "ping.metrics-report", scope: "operator.read", advertise: false },
