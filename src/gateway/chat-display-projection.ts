...
// Local fork: raised default chat history text cap from upstream's 8_000 to
// 100_000 chars (commit e4c6c182a4) so the protocol monitor can still display
// long agent transcripts that would otherwise be truncated.
