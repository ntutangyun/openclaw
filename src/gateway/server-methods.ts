...
const loadPingHandlers = lazyHandlerModule(
  () => import("./server-methods/ping.js"),
  (module) => module.pingHandlers,
);
...
export const coreGatewayHandlers: GatewayRequestHandlers = {
  ...createLazyCoreHandlers({
    methods: ["ping.peer-to-gw", "ping.gw-to-peer.ack", "ping.metrics-report"],
    loadHandlers: loadPingHandlers,
  }),
  ...createLazyCoreHandlers({
    methods: ["connect"],
