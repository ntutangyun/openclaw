...
import {
  ...
  type SessionsPurgeParams,
  SessionsPurgeParamsSchema,
  type TaskSummary,
  TaskSummarySchema,
...
} from "./schema/protocol-traces.js";
import { type TimeSyncParams, TimeSyncParamsSchema } from "./schema/time.js";
...
export const validateSessionsPurgeParams =
  lazyCompile<SessionsPurgeParams>(SessionsPurgeParamsSchema);
...
export const validateTimeSyncParams = lazyCompile<TimeSyncParams>(TimeSyncParamsSchema);
export const validateProtocolTracesRxReportParams = lazyCompile<ProtocolTracesRxReportParams>(
  ProtocolTracesRxReportParamsSchema,
);
